...
var lyr_JaringanJalan_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/JaringanJalan_2_0.png" /> A<br />\
    <img src="styles/legend/JaringanJalan_2_1.png" /> B<br />\
    <img src="styles/legend/JaringanJalan_2_2.png" /> C<br />\
    <img src="styles/legend/JaringanJalan_2_3.png" /> D<br />\
    <img src="styles/legend/JaringanJalan_2_4.png" /> E<br />\
    <img src="styles/legend/JaringanJalan_2_5.png" /> F<br />\
    <img src="styles/legend/JaringanJalan_2_6.png" /> <br />' });

lyr_CartoVoyagerLabels_0.setVisible(true);lyr_TataGunaLahan_1.setVisible(true);lyr_JaringanJalan_2.setVisible(true);
var layersList = [lyr_CartoVoyagerLabels_0,lyr_TataGunaLahan_1,lyr_JaringanJalan_2];
...
lyr_JaringanJalan_2.set('fieldAliases', {'id': 'id', 'nama': 'nama', 'fungsi_jal': 'fungsi_jal', 'tipe_jalan': 'tipe_jalan', 'jembatan': 'jembatan', 'lebar': 'lebar', 'volume': 'volume', 'kapasitas': 'kapasitas', 'vcr': 'vcr', 'kecepatan': 'kecepatan', 'los': 'los', 'hambatan_s': 'hambatan_s', 'satu_arah': 'satu_arah', 'terowongan': 'terowongan', 'Shape_Leng': 'Shape_Leng', 'tahun_surv': 'tahun_surv', });
...
lyr_JaringanJalan_2.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', 'fungsi_jal': 'TextEdit', 'tipe_jalan': 'TextEdit', 'jembatan': 'TextEdit', 'lebar': 'TextEdit', 'volume': 'TextEdit', 'kapasitas': 'TextEdit', 'vcr': 'TextEdit', 'kecepatan': 'TextEdit', 'los': 'TextEdit', 'hambatan_s': 'TextEdit', 'satu_arah': 'TextEdit', 'terowongan': 'TextEdit', 'Shape_Leng': 'TextEdit', 'tahun_surv': 'TextEdit', });
lyr_TataGunaLahan_1.set('fieldLabels', {'FID_Penggu': 'inline label - always visible', 'V_SURVEYOR': 'no label', 'STATUS': 'no label', 'KODE_SAMPE': 'no label', 'KEGIATAN_L': 'no label', 'SHAPE_LENG': 'no label', 'D_PENGGUNA': 'no label', 'D_SUB_PENG': 'no label', 'D_KEGIATAN': 'no label', 'D_KODE_KEG': 'no label', 'FID_ADM_KE': 'no label', 'KECAMATAN': 'no label', 'Shape_Le_1': 'no label', 'Shape_Area': 'no label', });
lyr_JaringanJalan_2.set('fieldLabels', {'id': 'inline label - always visible', 'nama': 'inline label - always visible', 'fungsi_jal': 'inline label - always visible', 'tipe_jalan': 'inline label - always visible', 'jembatan': 'inline label - always visible', 'lebar': 'inline label - always visible', 'volume': 'inline label - always visible', 'kapasitas': 'inline label - always visible', 'vcr': 'inline label - always visible', 'kecepatan': 'inline label - always visible', 'los': 'inline label - always visible', 'hambatan_s': 'inline label - always visible', 'satu_arah': 'inline label - always visible', 'terowongan': 'inline label - always visible', 'Shape_Leng': 'inline label - always visible', 'tahun_surv': 'inline label - always visible', });
lyr_JaringanJalan_2.on('precompose', function(evt) {
